...
// for more information read data sheet.
{
	...
	atmega128()->tc3->ocr3a = writeHLbyte(~0);
	atmega128()->tc3->ocr3b = writeHLbyte(~0);
	atmega128()->tc3->ocr3c = writeHLbyte(~0);
}
...
void TIMER_COUNTER3_wavegenmode(unsigned char wavegenmode)
{
	atmega128()->tc3->tccr3a.var &= ~((1 << WGM31) | (1 << WGM30));
	atmega128()->tc3->tccr3b.var &= ~((1 << WGM33) | (1 << WGM32));
	switch(wavegenmode){ // TOP -- Update of OCRnX -- TOV Flag Set on
		...
		atmega128()->tc3->tccr3b.var |= (1 << WGM33);
		break;
...
void TIMER_COUNTER3_interrupt(unsigned char interrupt)
{
	atmega128()->tc3->etimsk.var &= ~((1 << TICIE3) | (1 << OCIE3A) | (1 << OCIE3B) | (1 << TOIE3) | (1 << OCIE3C));
	switch(interrupt){ // ICP3  -->  PE7
		case 0:
		break;
		case 1:
		atmega128()->tc3->etimsk.var |= (1 << TOIE3);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 2:
		atmega128()->tc3->etimsk.var |= (1 << OCIE3A);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 3:
		atmega128()->tc3->etimsk.var |= (1 << OCIE3B);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 4:
		atmega128()->tc3->etimsk.var |= (1 << OCIE3C);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 5:
		atmega128()->tc3->etimsk.var |= (1 << TICIE3);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 6:
		atmega128()->tc3->etimsk.var |= (1 << OCIE3A) | (1 << TOIE3);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 7:
		atmega128()->tc3->etimsk.var |= (1 << OCIE3B) | (1 << TOIE3);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 8:
		atmega128()->tc3->etimsk.var |= (1 << TOIE3) | (1 << OCIE3C);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 9:
		atmega128()->tc3->etimsk.var |= (1 << TICIE3) | (1 << TOIE3);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 10:
		atmega128()->tc3->etimsk.var |= (1 << OCIE3A) | (1 << OCIE3B) | (1 << TOIE3);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 11:
		atmega128()->tc3->etimsk.var |= (1 << OCIE3A) | (1 << OCIE3B) | (1 << TOIE3) | (1 << OCIE3C);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 12:
		atmega128()->tc3->etimsk.var |= (1 << OCIE3A) | (1 << OCIE3B) | (1 << OCIE3C);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		default:
		break;
...
void TIMER_COUNTER3_compareA(uint16_t compare)
{
	atmega128()->tc3->ocr3a = writeHLbyte(compare);
}
void TIMER_COUNTER3_compareB(uint16_t compare)
{
	atmega128()->tc3->ocr3b = writeHLbyte(compare);
}
void TIMER_COUNTER3_compareC(uint16_t compare)
{
	atmega128()->tc3->ocr3c = writeHLbyte(compare);
}
uint8_t TIMER_COUNTER3_stop(void)
