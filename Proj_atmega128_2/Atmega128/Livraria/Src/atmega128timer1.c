...
// for more information read data sheet.
{
	...
	atmega128()->tc1->ocr1a = writeHLbyte(~0);
	atmega128()->tc1->ocr1b = writeHLbyte(~0);
	atmega128()->tc1->ocr1c = writeHLbyte(~0);
}
...
void TIMER_COUNTER1_wavegenmode(unsigned char wavegenmode)
{
	atmega128()->tc1->tccr1a.var &= ~((1 << WGM11) | (1 << WGM10));
	atmega128()->tc1->tccr1b.var &= ~((1 << WGM13) | (1 << WGM12));
	switch(wavegenmode){ // TOP -- Update of OCRnX at -- TOV Flag Set on
		...
		atmega128()->tc1->tccr1b.var |= (1 << WGM13);
		break;
...
void TIMER_COUNTER1_interrupt(unsigned char interrupt)
{
	atmega128()->tc1->timsk.var &= ~((1 << TICIE1) | (1 << OCIE1A) | (1 << OCIE1B) | (1 << TOIE1));
	atmega128()->tc1->etimsk.var &= ~(1 << OCIE1C);
	switch(interrupt){ // ICP1  -->  PD4
		case 0:
		break;
		case 1:
		atmega128()->tc1->timsk.var |= (1 << TOIE1);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 2:
		atmega128()->tc1->timsk.var |= (1 << OCIE1A);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 3:
		atmega128()->tc1->timsk.var |= (1 << OCIE1B);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 4:
		atmega128()->tc1->etimsk.var |= (1 << OCIE1C);
		...
		break;
		case 5:
		atmega128()->tc1->timsk.var |= (1 << TICIE1);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 6:
		atmega128()->tc1->timsk.var |= (1 << OCIE1A) | (1 << TOIE1);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 7:
		atmega128()->tc1->timsk.var |= (1 << OCIE1B) | (1 << TOIE1);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 8:
		atmega128()->tc1->timsk.var |= (1 << TOIE1);
		...
		break;
		case 9:
		atmega128()->tc1->timsk.var |= (1 << TICIE1) | (1 << TOIE1);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 10:
		atmega128()->tc1->timsk.var |= (1 << OCIE1A) | (1 << OCIE1B) | (1 << TOIE1);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		case 11:
		atmega128()->tc1->timsk.var |= (1 << OCIE1A) | (1 << OCIE1B) | (1 << TOIE1);
		...
		break;
		case 12:
		atmega128()->tc1->timsk.var |= (1 << OCIE1A) | (1 << OCIE1B);
		atmega128()->tc1->etimsk.var |= (1 << OCIE1C);
		atmega128()->cpu->sreg.var |= 1 << 7;
		break;
		default:
...
void TIMER_COUNTER1_compoutmodeC(unsigned char compoutmode)
{
	atmega128()->tc1->tccr1a.var &= ~(3 << COM1C0);
...
void TIMER_COUNTER1_compareA(uint16_t compare)
{
	atmega128()->tc1->ocr1a = writeHLbyte(compare);
}
void TIMER_COUNTER1_compareB(uint16_t compare)
{
	atmega128()->tc1->ocr1b = writeHLbyte(compare);
}
void TIMER_COUNTER1_compareC(uint16_t compare)
{
	atmega128()->tc1->ocr1c = writeHLbyte(compare);
}
uint8_t TIMER_COUNTER1_stop(void)
