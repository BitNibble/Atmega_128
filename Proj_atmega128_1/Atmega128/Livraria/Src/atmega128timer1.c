...
void TIMER_COUNTER1_interrupt(unsigned char interrupt)
{
	dev()->tc1->timsk.var &= ~((1 << TICIE1) | (1 << OCIE1A) | (1 << OCIE1B) | (1 << TOIE1));
	dev()->tc1->etimsk.var &= ~(1 << OCIE1C);
	switch(interrupt){ // ICP1  -->  PD4
		case 0:
		break;
		case 1:
		dev()->tc1->timsk.var |= (1 << TOIE1);
		dev()->cpu->sreg.var |= 1 << 7;
		break;
		case 2:
		dev()->tc1->timsk.var |= (1 << OCIE1A);
		dev()->cpu->sreg.var |= 1 << 7;
		break;
		case 3:
		dev()->tc1->timsk.var |= (1 << OCIE1B);
		dev()->cpu->sreg.var |= 1 << 7;
		break;
		case 4:
		dev()->tc1->etimsk.var |= (1 << OCIE1C);
		...
		break;
		case 5:
		dev()->tc1->timsk.var |= (1 << TICIE1);
		dev()->cpu->sreg.var |= 1 << 7;
		break;
		case 6:
		dev()->tc1->timsk.var |= (1 << OCIE1A) | (1 << TOIE1);
		dev()->cpu->sreg.var |= 1 << 7;
		break;
		case 7:
		dev()->tc1->timsk.var |= (1 << OCIE1B) | (1 << TOIE1);
		dev()->cpu->sreg.var |= 1 << 7;
		break;
		case 8:
		dev()->tc1->timsk.var |= (1 << TOIE1);
		...
		break;
		case 9:
		dev()->tc1->timsk.var |= (1 << TICIE1) | (1 << TOIE1);
		dev()->cpu->sreg.var |= 1 << 7;
		break;
		case 10:
		dev()->tc1->timsk.var |= (1 << OCIE1A) | (1 << OCIE1B) | (1 << TOIE1);
		dev()->cpu->sreg.var |= 1 << 7;
		break;
		case 11:
		dev()->tc1->timsk.var |= (1 << OCIE1A) | (1 << OCIE1B) | (1 << TOIE1);
		...
		break;
		case 12:
		dev()->tc1->timsk.var |= (1 << OCIE1A) | (1 << OCIE1B);
		dev()->tc1->etimsk.var |= (1 << OCIE1C);
		dev()->cpu->sreg.var |= 1 << 7;
		break;
		default:
